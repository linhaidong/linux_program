...
extern int server_send(int fd, int pid, char *buf, int len);
extern int client_addr_init(local_addr *addr);
extern int container_msg_recv(local_addr * addr, char *buf, int len);
#endif

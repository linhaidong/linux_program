...
int netlink_rcv(struct nl_handler *handler, struct nlmsg *nlmsg, int len);
//int netlink_rcv(struct nl_handler *handler, char * buf, int len);
/*
...
int netlink_transaction_getinfo(struct nl_handler *handler,struct nlmsg *request, struct nlmsg *answer);

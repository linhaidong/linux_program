...
#-*- coding:utf-8 -*-  
############################  
#File Name: sssl_server.py
#Author: linengier  
#Mail: linengier@126.com  
#Created Time: 2017-01-11 19:29:05
############################ 
import socket, os  
...
CERTIFICATE_PATH = os.getcwd() + '/cert.pem'  
...
def test(HandlerClass = MemberUpdateHandler, ServerClass = SecureHTTPServer):  
    server_address = ('', 4242)  
